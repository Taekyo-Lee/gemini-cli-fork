...
import fs from 'node:fs'; // [FORK] IME debug logging
    ...
    (submittedValue: string) => {
      ...
      try {
        fs.appendFileSync(
          ...
          `[SUBMIT] raw=${JSON.stringify(submittedValue)} buf.text=${JSON.stringify(buffer.text)} latest=${JSON.stringify(buffer.getLatestText())}\n`,
        );
      } catch {
        /* ignore write errors */
      }
