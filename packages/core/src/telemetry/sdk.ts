...
// [FORK] Silent no-op log exporter for Langfuse (which doesn't support /v1/logs)
...
export async function initializeTelemetry(
  ...
  const isLangfuse = config.getTelemetryLangfuse(); // [FORK] skip unsupported endpoints
