...
| ------------------------------- | ----------- | ---------------------- |
| `COMPANY`, `PRODUCTION`, `CORP` | CORP        | 8 on-prem models       |
| `DEVELOPMENT`, `DEV`            | DEV         | 6 + 12 + 1 = 19 models |
...
See the [Install Guide](../INSTALL_GUIDE.md) for setup instructions.
...
| File                                               | Role                                  |
| -------------------------------------------------- | ------------------------------------- |
| `packages/core/src/config/llmRegistry.ts`          | Model registry (27 models)            |
